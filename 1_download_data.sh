...
wget --no-check-certificate "https://singlecell.broadinstitute.org/single_cell/api/v1/bulk_download/generate_curl_config?accessions=SCP1064&auth_code=dxavarJ1&directory=all&context=study" -O cfg.txt
